#!/usr/bin/env python
"""
python scripts/sync.py -u yilu -o dpr-training-2.us-west1-b.training-pipeline-274108
"""
import argparse
import subprocess
...
def get_upload_command(command_args: Dict[str, str]) -> str:
    ...
    """
    return (
        'rsync -Pauv -e "ssh -F /Users/{username}/.ssh/config" --exclude=".git/" '
